...
func (s *Service) Create(ctx context.Context, req CreateRequest, actorID int) (*AttributeVolunteer, error) {
...
func (s *Service) GetByID(ctx context.Context, id int) (*AttributeVolunteer, error) {
	return s.Repo.GetByID(ctx, id)
}

func (s *Service) Update(ctx context.Context, id int, req UpdateRequest, actorID int) (*AttributeVolunteer, error) {
